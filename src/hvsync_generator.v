...
module hvsync_generator(clk, mode, hsync, vsync, display_on, hpos, vpos);
    ...
    // [1]  XGA (  VESA DMT) 1024 x  768 @ 60 fps (65.000 MHz) VESA DMT
    ...
    parameter [12*NM-1:0] H_ACTIVE_PIXELS = {12'd1920, 12'd1280, 12'd1024, 12'd640}; // horizontal display width
    parameter [11*NM-1:0] H_FRONT_PORCH   = {11'd  88, 11'd 110, 11'd  24, 11'd 16}; // horizontal right border
    parameter [11*NM-1:0] H_SYNC_WIDTH    = {11'd  44, 11'd  40, 11'd 136, 11'd 96}; // horizontal sync width
    parameter [11*NM-1:0] H_BACK_PORCH    = {11'd 148, 11'd 220, 11'd 160, 11'd 48}; // horizontal left border
    parameter [   NM-1:0] H_SYNC          = { 1'b   1,  1'b   1,  1'b   0,  1'b  0}; // 0 (-), 1 (+)
    parameter [11*NM-1:0] V_ACTIVE_LINES  = {11'd1080, 11'd 720, 11'd 768, 11'd480}; // vertical display height
    parameter [10*NM-1:0] V_FRONT_PORCH   = {10'd   4, 10'd   5, 10'd   3, 10'd 10}; // vertical bottom border
    parameter [10*NM-1:0] V_SYNC_HEIGHT   = {10'd   5, 10'd   5, 10'd   6, 10'd  2}; // vertical sync # lines
    parameter [10*NM-1:0] V_BACK_PORCH    = {10'd  36, 10'd  20, 10'd  29, 10'd 33}; // vertical top border
    parameter [   NM-1:0] V_SYNC          = { 1'b   1,  1'b   1,  1'b   0,  1'b  0}; // 0 (-), 1 (+)
