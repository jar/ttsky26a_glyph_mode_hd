...
module hvsync_generator(clk, mode, hsync, vsync, display_on, hpos, vpos);
    ...
    // [3]  FHD (     1080p) 1920 x 1080 @ 60 fps (133.320 MHz) CVT-RBv2
    //--------[ Bit width ] ----- Mode------      [3]       [2]      [1]      [0]
    parameter [11*NM-1:0] H_ACTIVE_PIXELS = {11'd1920, 11'd1280, 11'd800, 11'd640}; // horizontal display width
    parameter [10*NM-1:0] H_FRONT_PORCH   = {10'd   8, 10'd 110, 10'd 40, 10'd 16}; // horizontal right border
    parameter [10*NM-1:0] H_SYNC_WIDTH    = {10'd  32, 10'd  40, 10'd128, 10'd 96}; // horizontal sync width
    parameter [10*NM-1:0] H_BACK_PORCH    = {10'd  40, 10'd 220, 10'd 88, 10'd 48}; // horizontal left border
    ...
    parameter [10*NM-1:0] V_FRONT_PORCH   = {10'd  17, 10'd   5, 10'd  1, 10'd 10}; // vertical bottom border
    parameter [10*NM-1:0] V_SYNC_HEIGHT   = {10'd   8, 10'd   5, 10'd  4, 10'd  2}; // vertical sync # lines
    parameter [10*NM-1:0] V_BACK_PORCH    = {10'd   6, 10'd  20, 10'd 23, 10'd 33}; // vertical top border
